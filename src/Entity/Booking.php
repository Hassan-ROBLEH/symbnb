...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit être plus éloignée que la date d'arriver !")
     */
    private $endDate;
    ...
    public function prePersist() {
        ...
        if(empty($this->amount)) {
            // multiple le prix d'annonce par nombre de jour / prix de l'annonce * nombre de jour
